...
import com.example.bookshop_xml.databinding.ItemBookBinding
...
class Adapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            btnDetail.setOnClickListener { onDetail(book.id) }
            btnBeli.setOnClickListener { onBeli(book.olshopUrl) }
        }
    }
